...
class PaymentResponse
{
     ...
     */
    public function __construct(string $operation, string $ordernumber, string $merordernum = null, string $md = null, int $prcode, int $srcode, string $resulttext, string $digest, string $digest1)
    {
